...
public class AnnouncementPostController {
	...
	public ResponseEntity<Void> postAnnouncement(@RequestParam String title, @RequestParam String content, @RequestParam String writer,
												   ...
												   @RequestPart(value="attached", required=false) List<MultipartFile> files) throws DataSaveException {
